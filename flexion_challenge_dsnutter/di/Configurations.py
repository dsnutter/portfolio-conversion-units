...
class Configurations():
    ...
    #hash = Configurations.conversions_file_to_dict('dsnutter_conversion_units/configuration/conversions_config.csv', BackendTypes.CSV)
    #Configurations.save_conversion_dict_to_file(hash, './temp.json', BackendTypes.JSON)

    # convert the JSON confg to CSV
    #hash = Configurations.conversions_file_to_dict('dsnutter_conversion_units/configuration/conversions_config.json', BackendTypes.JSON)
    #Configurations.save_conversion_dict_to_file(hash, './temp.csv', BackendTypes.CSV)

    # Responses, CSV to JSON
    #hash = Configurations.responses_file_to_dict('dsnutter_conversion_units/configuration/responses_config.csv', BackendTypes.CSV)
